...
const state = {
	...
	backgroundColor,													   // enable sidebar background image
	selectBackgroundColor: backgroundColor[0],                  						 // enable sidebar background color
...
const getters = {
	...
	selectBackgroundColor: state => {
		return state.selectBackgroundColor
	}
}
