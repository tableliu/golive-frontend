<template lang="html">
  <div class="notfund-body head-info">
    <nav class="shelf">
      <a class="book home-page" @click.stop="goBack">返回上一层</a>
      <a class="book about-us"></a>
      <a class="book contact"></a>
      <a class="book faq" @click.stop="goHome">首页</a>
      <span class="book not-found">404</span>
      <span class="door door-left"></span>
      <span class="door door-right"></span>
    </nav>
    <h1 style="margin-top:5rem;font-size: 5rem;">404 Error</h1>
    <h3>您访问的页面不存在</h3>
  </div>
</template>
