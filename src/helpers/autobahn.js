...
/** @define {string} */
var AUTOBAHNJS_VERSION = '1.0.0';

/** @define {boolean} */
var AUTOBAHNJS_DEBUG = false;
...
ab._clientType = "web";  //用于标识client端
...
ab.Session = function (wsuri, onopen, onclose, options) {
    ...
    if ("WebSocket" in window) {
        ...
        self._websocket = new WebSocket(self._wsuri, [ab._subprotocol, ab._clientType]);
    } else if ("MozWebSocket" in window) {
        // older versions of Firefox prefix the WebSocket object
        self._websocket = new MozWebSocket(self._wsuri, [ab._subprotocol, ab._clientType]);
    } else {
